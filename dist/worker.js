...
function patchComponent (now, old, context) {
    ...
    if (old.node !== now.node) {
        ...
        instance = new (PizzaContructor.get())(now.componentOptions, {
...
PizzaContructor.set(Pizza);

var WorkerPizza = /** @class */ (function (_super) {
    __extends(WorkerPizza, _super);
    function WorkerPizza() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WorkerPizza.prototype._patch = function (vnode) {
        return this.$vnode = vnode;
    };
    WorkerPizza.prototype.$mount = function () {
        if (this.$mounted)
            return;
        this._render();
        this.$mounted = true;
...
var worker = PizzaContructor.set(WorkerPizza);
